...
<!--             <div class="form-group mform col-sm-12 mb-3">
            ...
            <div class="form-group mform col-sm-12" id="signup" >
             <center><input type="submit" id="submit" value="SIGN UP" class="d-block w-100 bg-success text-light w-50 rounded"></center>
           </div>
         </div>
       </form>
       ...
       <br>
       <center>
        <span>Already have an account? <a href="{{ url('user-login') }}" class="text-success">Login</a></span>
