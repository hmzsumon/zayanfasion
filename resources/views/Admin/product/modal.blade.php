            ...
            <form method="post" action="{{route('product-add.update',$data->id)}}" name="basic_validate"  novalidate="novalidate" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="control-group mb-3">
                  ...
                  <div class="controls">
                    <input type="number" name="sale_price" id="sale_price" class="form-control" class="form-control" placeholder="Sale Price"  value="{{$data->sale_price}}"/>
                  </div>
                </div> 
                <div class="control-group mb-3">
                  <label class="control-label">Discount Amount</label>
                  <div class="controls">
                    <input type="number" name="discount_price" id="discount_price" class="form-control" class="form-control" placeholder="Discount Amount"  value="{{$data->discount_price}}"/>
                  </div>
                </div>
                ...
                <div class="control-group mb-3">
                  ...
                  <div class="controls">
                    <input type="number" name="discount_per" id="discount_per" class="form-control" class="form-control" placeholder="Discount percentage"  value="{{$data->discount_per}}" />
                  </div>
                </div>
                ...
                <div class="control-group mb-3">
                  ...
                  <div class="controls">
                    <input type="number" name="current_price" id="current_price" class="form-control" class="form-control" placeholder="Cuurent Price"  value="{{$data->current_price}}"/>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="control-group mb-3">
                  ...
                  <div class="controls">
                        ...
                        @endphp
                        @if($data->image)
                        <img src="{{asset('/public/productImage')}}/{{$data->image}}" alt="">
                        @endif
                    ...
                    <input type="file" name="image[]" id="image" multiple>
                        ...
                        <div class="row">
                          @foreach($images as $img)
                            <img src="{{asset('/public/productImage')}}/{{$img->image}}" alt="" style="width: 9rem;">
                          @endforeach
                        </div>
                  </div>
                </div>
