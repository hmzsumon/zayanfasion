                        ...
                        <div class="mb-4">
                            ...
                            <div class="card-body">
                                <table id="example" class="display nowrap" style="width:100%;text-align:center;">
                                    ...
                                    if($invoicestatus)
                                    {
                                    $startdate = substr($invoicestatus->created_at,0,10);
                                    $packagedays = $invoicestatus->package_days;
                                    $enddate = strftime("%Y-%m-%d", strtotime("$startdate +$packagedays day"));
                                        
                                        $holydaycount = DB::table('holyday')
                                    ->whereBetween('holyday.date',[$startdate,$enddate])
                                    ->count();
                                    
                                    $deliveryDay = strftime("%Y-%m-%d", strtotime("$enddate +$holydaycount day"));
                                    }
                                    else
                                    {
                                     $startdate = $showdata->created_at;
                                    }
                                      ...
                                      <tr id="tr-{{$showdata->invoice_id}}">
                                        ...
                                        <td data-toggle="tooltip" title="Package Type">
                                            
                                           @if($showdata->package_id == '0')
                                           <span style="color:gray;"><b>General Order</b></span>
                                           @elseif($showdata->package_id == '5')
                                           <span style="color:green;"><b>Discount Mela</b></span>
                                           @elseif($showdata->package_id == '7')
                                            <span style="color:red;"><b>Life Style Mela</b> </span>
                                           @elseif($showdata->package_id == '8')
                                            <span style="color:blue;"><b>Gadget Mela</b></span>
                                           @elseif($showdata->package_id == '9')
                                            <span style="color:orange;"><b>Deshi Mela</b></span>
                                            @endif
                                        ...
                                        <td data-toggle="tooltip" title="Date">{{$showdata->created_at}}</td>
                                         <td data-toggle="tooltip" title="Delivery Date">{{$deliveryDay}}</td>
                                        ...
                                        <td data-toggle="tooltip" title="Billing address">{{$showdata->vessel_name}}</td>
                                        <td data-toggle="tooltip" title="shipping address">{{$showdata->rank}}</td>
                                        ...
                                        <td data-toggle="tooltip" title="Discount Percentage">
                                           ...
                                           <li>{{floor($productdata->dp/$productdata->sp*100)}}%,</li>
                                            ...
                                            @endforeach
                                            @endif
                                            <!--{{floor($showdata->discount_price/$showdata->sale_price*100)}}%-->
