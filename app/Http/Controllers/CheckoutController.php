...
class CheckoutController extends Controller
{
  ...
  public function Checkout_order()
  {
    ...
    return view('User.checkout',compact('deliverycharge','district','vieworder','control'));
  }
...
public function invoicepaper($session)
{
 ...
 ->select('invoices.*','delivery_infos.*','shopping_carts.quantity','shopping_carts.color','shopping_carts.size',
  ...
  'shopping_carts.sale_price','shopping_carts.discount_price','shopping_carts.current_price','districts.district_name',
