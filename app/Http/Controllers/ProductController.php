...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      $insert = array(
        ...
        'call_for_order'=>$request->call_for_order,
...
// }
    ...
    public function edit($id)
    {
     ...
     return view('Admin.product.modal',compact('offer','data','iteminfo','company','measurementinfo','sizes','product_sizes','colors','product_colors','seller','shipping', 'images'));
   }
